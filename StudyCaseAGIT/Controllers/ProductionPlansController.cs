...
namespace StudyCaseAGIT.Controllers
{
    public class ProductionPlansController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Calculate(int monday, int tuesday, int wednesday, int thursday, int friday, DateTime plandate, ProductionPlan prodPlan)
        {
            int[] initialPlan = { monday, tuesday, wednesday, thursday, friday };
            ...
            // Gunakan RedirectToAction untuk kembali ke Index
